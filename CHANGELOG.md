...
- **Community files**: CONTRIBUTING, CODE_OF_CONDUCT, SECURITY, issue forms (bug, false positive, detection gap, feature), PR template, Discussion category forms, FUNDING (GitHub Sponsors), CODEOWNERS and Dependabot.
- Product renamed to **Kill Line** (the command stays `killline`).
